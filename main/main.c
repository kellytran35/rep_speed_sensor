...
void app_main(void)
{
    ...
    xTaskCreate(ultrasonic_control, "Ultrasonic control", 2048, gptimer, 1, NULL);
    xTaskCreate(ultrasonic_meas, "Ultrasonic measurement", 4096, gptimer, 5, &meas_task_handle);
